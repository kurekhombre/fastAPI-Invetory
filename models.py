...
class Product(Model):
    ...
    unit_price = fields.DecimalField(max_digits=8, decimal_places=2)
...
product_pydatnic = pydantic_model_creator(Product, name='Product')
product_pydatnicIn = pydantic_model_creator(Product, name='ProductIn', exclude_readonly=True)
